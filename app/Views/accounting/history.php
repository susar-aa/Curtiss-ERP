        ...
        <table class="ledger-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 33%;">Description / Memo</th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><span style="background:rgba(0,102,204,0.05); color:#0066cc; padding:2px 6px; border-radius:4px; font-weight:600; font-size:11px; font-family:monospace;"><?= htmlspecialchars($tx->reference) ?></span></td>
