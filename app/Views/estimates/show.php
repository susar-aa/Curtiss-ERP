...
<body>
            ...
            <div class="invoice-header">
                ...
                <div class="invoice-meta">
                    ...
                    <table class="meta-table">
                        ...
                        <tr>
                            <th>Date:</th>
                            <td><?= date('d-M-Y', strtotime($data['estimate']->invoice_date ?? date('Y-m-d'))) ?></td>
                        </tr>
    ...
    <script>
        function exportToExcel() {
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="text-align: right; border-bottom: 2px solid #000; padding-bottom: 10px;">
                                <strong>Invoice No:</strong> <?= htmlspecialchars($data['estimate']->estimate_number) ?><br>
                                <strong>Date:</strong> <?= date('d-M-Y', strtotime($data['estimate']->invoice_date ?? date('Y-m-d'))) ?><br>
                                <?php if(!empty($paymentTermName)): ?>
            ...
            link.download = 'Invoice_<?= htmlspecialchars($data['estimate']->estimate_number) ?>.xls';
