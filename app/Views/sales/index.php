    ...
    <div class="qb-container">
        <form action="<?= APP_URL ?>/sales/store" method="POST" id="invoiceForm">
                ...
                <div class="inv-header-row">
                    ...
                    <div class="customer-card">
                        ...
                        <div class="customer-card-body">
                            ...
                            <div id="customerOptionsContainer" class="customer-actions">
                            ...
                            <div id="customerOutstanding" class="customer-outstanding"></div>
                        </div>
                    </div>
                    ...
                    <div class="inv-meta-card">
                        ...
                        <div class="inv-meta-body">
                            ...
                            <!-- 5-field strip: PO / Terms / Due Date / Rep / Rep TP -->
                            <div class="inv-fields-strip">
                                <div class="inv-field-col">
                                    <div class="inv-field-label">P.O. No.</div>
                                    <input type="text" name="po_number" class="inv-field-input"
                                           value="<?= ($inv && isset($inv->po_number)) ? htmlspecialchars((string)$inv->po_number) : '' ?>"
                                ...
                                <div class="inv-field-col">
                                    <div class="inv-field-label">Rep TP #</div>
                                    <input type="text" name="rep_tp" id="displayPhone" class="inv-field-input"
                                           value="<?= ($inv && isset($inv->rep_tp)) ? htmlspecialchars((string)$inv->rep_tp) : '' ?>"
                                           placeholder="Phone #">
                                </div>
                            </div>
                        </div>
            ...
            <div class="inv-action-bar">
                <div class="inv-action-status">
                    <div class="status-dot"></div>
                    System Ready
                </div>
                <div class="inv-action-buttons">
                    <button type="submit" name="save_action" value="close" class="btn btn-primary">
                        <i class="ph ph-floppy-disk"></i> Save &amp; Close
                    </button>
                    <?php if (!$inv): ?>
                        <button type="submit" name="save_action" value="new" class="btn">
                            <i class="ph ph-plus"></i> Save &amp; New
                        </button>
                        <button type="submit" name="save_action" value="print" class="btn">
                            <i class="ph ph-printer"></i> Save &amp; Print
                        </button>
                        <button type="submit" name="save_action" value="whatsapp" class="btn btn-wa">
